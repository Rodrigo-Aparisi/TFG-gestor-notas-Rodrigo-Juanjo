...
router.post('/request-reset', rateLimiter_1.passwordResetLimiter, passwordController_1.passwordController.requestReset);
...
router.post('/reset', rateLimiter_1.passwordResetConfirmLimiter, passwordController_1.passwordController.resetPassword);
